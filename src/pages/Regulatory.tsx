...
import { FileCheck, AlertCircle, Clock, Globe } from "lucide-react";
...
const Regulatory = () => {
  ...
  const metrics = [
    { label: "Active Submissions", value: "47", icon: FileCheck, color: "text-primary" },
    ...
    <DashboardLayout>
      <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <GlassCard>
            <h2 className="text-xl font-semibold text-foreground mb-6">Priority Regulatory Submissions</h2>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-medium text-foreground">{submission.agency}</p>
                    </div>
                    <div>
                      <p className="text-xs text-muted-foreground mb-1">Type</p>
                      <p className="text-sm font-medium text-foreground">{submission.type}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <p className="text-xs text-muted-foreground mb-1">Target Decision</p>
